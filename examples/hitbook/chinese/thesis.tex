...
%     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[fontset=fandol,type=bachelor,campus=weihai, tocblank=false]{hithesisbook}
% 此处选项中不要有空格
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 必填选项
...
\makecover
% \includepdf[page=1](extra/cover.pdf)
...
\include{body/predict}
% \include{body/track}
\include{body/anti_top}
\include{body/sb}
\backmatter
...
\bibliography{reference} % 参考文献
% \authorization %授权 
\authorization[extra/yc35.pdf] %添加扫描页的命令，与上互斥
\include{back/acknowledgements} %致谢
\begin{appendix}%附录
\input{back/tools}
\input{back/camera_disp}
