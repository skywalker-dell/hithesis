...
其中$F$为阻力，$k$为最终空气阻力系数，$\rho$为空气密度，一般取$1.293kg/m^3$，S为球截面积，$v$为球体速度，$C_d$为阻力系数，与雷诺数$R_e$有关系，关系如图\ref{空气阻力系数与雷诺数关系}所示。
...
如上所述，我们只考虑水平方向的空气阻力。弹丸的动力学微分方程见公式（6-3）和（6-4），
